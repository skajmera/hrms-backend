...
### API Documentation
- **Swagger UI**: `https://hrms-backend-khq1.onrender.com/api/v1/docs`
- **Swagger JSON**: `https://hrms-backend-khq1.onrender.com/api/v1/docs.json`

### Base URLs
- **Development**: `https://hrms-backend-khq1.onrender.com/api/v1`
...
## 🌐 API Base URL
```javascript
const API_BASE_URL = process.env.REACT_APP_API_URL || 'https://hrms-backend-khq1.onrender.com/api/v1';
```
...
- **Documentation**: https://hrms-backend-khq1.onrender.com/api/v1/docs
