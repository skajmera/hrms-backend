 ...
 */
router.get('/', leave_controller_1.leaveController.getAllLeaves.bind(leave_controller_1.leaveController));
/**
 * @swagger
 * /hr/leave/pending:
 *   get:
 ...
 *                     $ref: '#/components/schemas/Leave'
 */
router.get('/pending', (0, auth_middleware_1.authorize)(constants_1.USER_ROLES.SUPER_ADMIN, constants_1.USER_ROLES.HR_ADMIN, constants_1.USER_ROLES.MANAGER), leave_controller_1.leaveController.getPendingLeaves.bind(leave_controller_1.leaveController));
/**
 * @swagger
 ...
 *                     $ref: '#/components/schemas/Leave'
 */
router.get('/on-leave-today', (0, auth_middleware_1.authorize)(constants_1.USER_ROLES.SUPER_ADMIN, constants_1.USER_ROLES.HR_ADMIN, constants_1.USER_ROLES.MANAGER), leave_controller_1.leaveController.getEmployeesOnLeaveToday.bind(leave_controller_1.leaveController));
/**
 * @swagger
...
*/ router.get('/:id', leave_controller_1.leaveController.getLeaveById.bind(leave_controller_1.leaveController));
/**
...
*/
router.post('/', (0, validation_1.validate)(leave_validation_1.applyLeaveValidation), leave_controller_1.leaveController.applyLeave.bind(leave_controller_1.leaveController));
/**
...
responses:
  ...
  404:
    description: Leave not found
*/ router.put('/:id/approve', (0, auth_middleware_1.authorize)(constants_1.USER_ROLES.SUPER_ADMIN, constants_1.USER_ROLES.HR_ADMIN, constants_1.USER_ROLES.MANAGER), (0, validation_1.validate)(leave_validation_1.approveRejectLeaveValidation), leave_controller_1.leaveController.approveLeave.bind(leave_controller_1.leaveController));
/**
...
responses:
  ...
  404:
    description: Leave not found
*/ router.put('/:id/reject', (0, auth_middleware_1.authorize)(constants_1.USER_ROLES.SUPER_ADMIN, constants_1.USER_ROLES.HR_ADMIN, constants_1.USER_ROLES.MANAGER), (0, validation_1.validate)(leave_validation_1.approveRejectLeaveValidation), leave_controller_1.leaveController.rejectLeave.bind(leave_controller_1.leaveController));
