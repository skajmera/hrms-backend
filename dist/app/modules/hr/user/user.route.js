 ...
 */
router.get('/all-with-draft', (0, auth_middleware_1.authorize)(constants_1.USER_ROLES.SUPER_ADMIN, constants_1.USER_ROLES.HR_ADMIN), (0, validation_1.validate)(user_validation_1.queryUsersValidation), user_controller_1.userController.getAllUsersWithDraft.bind(user_controller_1.userController));
/**
 * @swagger
 * /hr/users:
 *   get:
 ...
 *                         type: number
 */
router.get('/stats', (0, auth_middleware_1.authorize)(constants_1.USER_ROLES.SUPER_ADMIN, constants_1.USER_ROLES.HR_ADMIN), user_controller_1.userController.getUserStats.bind(user_controller_1.userController));
/**
 * @swagger
 ...
 *         description: User not found
 */
router.delete('/:id', (0, auth_middleware_1.authorize)(constants_1.USER_ROLES.SUPER_ADMIN), (0, validation_1.validate)(user_validation_1.getUserValidation), user_controller_1.userController.deleteUser.bind(user_controller_1.userController));
