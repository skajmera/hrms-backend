 ...
 */
router.put('/company-info', (0, validation_1.validate)(settings_validation_1.SettingsValidation.updateCompanyInfo), settings_controller_1.SettingsController.updateCompanyInfo);
/**
 * @swagger
 * /settings/locale:
 *   put:
 ...
 *         description: Unauthorized
 */
router.put('/locale', (0, validation_1.validate)(settings_validation_1.SettingsValidation.updateLocale), settings_controller_1.SettingsController.updateLocale);
/**
 * @swagger
 ...
 *         description: Unauthorized
 */
router.get('/work-schedules', settings_controller_1.SettingsController.getWorkSchedules);
/**
 * @swagger
 ...
 */
router.get('/work-schedules/:id', settings_controller_1.SettingsController.getWorkScheduleById);
/**
 * @swagger
 * /settings/work-schedules:
 *   post:
 ...
 *         description: Validation error
 */
router.post('/work-schedules', (0, validation_1.validate)(settings_validation_1.SettingsValidation.createWorkSchedule), settings_controller_1.SettingsController.createWorkSchedule);
/**
 * @swagger
 * /settings/work-schedules/{id}:
 *   put:
 ...
 */
router.put('/work-schedules/:id', settings_controller_1.SettingsController.updateWorkSchedule);
/**
 * @swagger
 * /settings/work-schedules/{id}:
 *   delete:
 ...
 */
router.delete('/work-schedules/:id', settings_controller_1.SettingsController.deleteWorkSchedule);
/**
 * @swagger
 ...
 *         description: Unauthorized
 */
router.put('/notifications', (0, validation_1.validate)(settings_validation_1.SettingsValidation.updateNotifications), settings_controller_1.SettingsController.updateNotifications);
/**
 * @swagger
 ...
 */
router.get('/designations', settings_controller_1.SettingsController.getDesignations);
/**
 * @swagger
 ...
 */
router.get('/designations/:id', settings_controller_1.SettingsController.getDesignationById);
/**
 * @swagger
 * /settings/designations:
 *   post:
 ...
 */
router.post('/designations', (0, validation_1.validate)(settings_validation_1.SettingsValidation.createDesignation), settings_controller_1.SettingsController.createDesignation);
/**
 * @swagger
 * /settings/designations/{id}:
 *   put:
 ...
 */
router.put('/designations/:id', settings_controller_1.SettingsController.updateDesignation);
/**
 * @swagger
 * /settings/designations/{id}:
 *   delete:
 ...
 */
router.delete('/designations/:id', settings_controller_1.SettingsController.deleteDesignation);
/**
 * @swagger
 ...
 */
// Change Password
router.post('/change-password', (0, validation_1.validate)(settings_validation_1.SettingsValidation.changePassword), settings_controller_1.SettingsController.changePassword);
// Security Settings
router.get('/security', settings_controller_1.SettingsController.getSecuritySettings);
router.put('/security', (0, auth_middleware_1.authorize)(constants_1.USER_ROLES.SUPER_ADMIN), (0, validation_1.validate)(settings_validation_1.SettingsValidation.updateSecurity), settings_controller_1.SettingsController.updateSecuritySettings);
